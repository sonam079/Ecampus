...
class QaQuestionIndexView(ListView):
    ...
    def get_context_data(self, *args, **kwargs):
        ...
        tabs = ['latest', 'unans']
        stud = student.objects.get(user_student=self.request.user)
        context['pk1'] = stud.batch
        context['pk'] = stud.student_id
        context['pk4'] = stud.program
...
class QaCreateQuestionView(LoginRequired, CreateView):
    ...
    def get_context_data(self, *args, **kwargs):
        context = super(
            QaCreateQuestionView, self).get_context_data(*args, **kwargs)
        stud = student.objects.get(user_student=self.request.user)
        context['pk1'] = stud.batch
        context['pk'] = stud.student_id
        context['pk4'] = stud.program
...
class QaUpdateQuestionView(LoginRequired, AuthorRequiredMixin, UpdateView):
    ...
    def get_context_data(self, *args, **kwargs):
        context = super(
            QaUpdateQuestionView, self).get_context_data(*args, **kwargs)
        stud = student.objects.get(user_student=self.request.user)
        context['pk1'] = stud.batch
        context['pk'] = stud.student_id
        context['pk4'] = stud.program
...
class QaCreateAnswerView(LoginRequired, CreateView):
    ...
    def get_context_data(self, *args, **kwargs):
        context = super(
            QaCreateAnswerView, self).get_context_data(*args, **kwargs)
        stud = student.objects.get(user_student=self.request.user)
        context['pk1'] = stud.batch
        context['pk'] = stud.student_id
        context['pk4'] = stud.program
...
class QaUpdateAnswerView(LoginRequired, AuthorRequiredMixin, UpdateView):
    ...
    def get_context_data(self, *args, **kwargs):
        context = super(
            QaUpdateAnswerView, self).get_context_data(*args, **kwargs)
        stud = student.objects.get(user_student=self.request.user)
        context['pk1'] = stud.batch
        context['pk'] = stud.student_id
        context['pk4'] = stud.program
...
class QaCreateAnswerCommentView(LoginRequired, CreateView):
    ...
    def get_context_data(self, *args, **kwargs):
        context = super(
            QaCreateAnswerCommentView, self).get_context_data(*args, **kwargs)
        stud = student.objects.get(user_student=self.request.user)
        context['pk1'] = stud.batch
        context['pk'] = stud.student_id
        context['pk4'] = stud.program
...
class QaCreateQuestionCommentView(LoginRequired, CreateView):
    ...
    def get_context_data(self, *args, **kwargs):
        context = super(
            QaCreateQuestionCommentView, self).get_context_data(*args, **kwargs)
        stud = student.objects.get(user_student=self.request.user)
        context['pk1'] = stud.batch
        context['pk'] = stud.student_id
        context['pk4'] = stud.program
